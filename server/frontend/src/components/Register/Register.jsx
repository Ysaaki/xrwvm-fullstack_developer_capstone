...
const Register = () => {
  ...
  const [lastName, setLastName] = useState(""); // Fixed lowercase 's' to capital 'L' here
    ...
    <div className="register_container" style={{width: "50%", margin: "50px auto"}}>
      <div className="header" style={{display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
          ...
          <div style={{display: "flex", flexDirection: "row", justifySelf: "end", alignSelf: "start"}}>
            <a href="/" onClick={gohome} style={{display: "flex", justifyContent: "space-between", alignItems:"center"}}>
      ...
      <form onSubmit={register}>
        <div className="inputs">
          ...
          <div className="input">
            ...
            <input type="text" name="last_name" placeholder="Last Name" className="input_field" onChange={(e) => setLastName(e.target.value)} required/> {/* Fixed matching state setter */}
          </div>

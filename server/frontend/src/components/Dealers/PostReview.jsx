...
const PostReview = () => {
  ...
  const [model, setModel] = useState(""); // Fixed: Initialized as an empty string to prevent validation edge crashes
  ...
  const get_dealer = async () => {
    ...
    if (retobj.status === 200) {
      // FIXED: Set the single dealer dictionary directly without processing it as an array list
      if (retobj.dealer) {

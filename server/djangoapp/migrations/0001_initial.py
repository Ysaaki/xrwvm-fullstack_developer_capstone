    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('type', models.CharField(choices=[('SUV', 'SUV'), ('Sedan', 'Sedan'), ('Coupe', 'Coupe'), ('Minivan', 'Minivan'), ('Convertible', 'Convertible'), ('Pickup', 'Pickup'), ('Hatchback', 'Hatchback')], default='SUV', max_length=20)),
